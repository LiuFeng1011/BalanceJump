...
public static class GameConst  {
    ...
    public const int WATCH_AD_REWAER_COUNT = 200;
    ...
    public const string USERDATANAME_SELECT_ROLE = "selroleid";
    public const string USERDATANAME_UNLOCK_ROLE = "unlockroleid_";

    public const float JUMP_FORCE = 3f;

    public static GameModel[] gameModels = {
        new GameModel(0,"Normal","TouchColor_Normal_Leaderboard"),
    };
